...
class EntityCountUpdater:
    ...
    def _update_loop(self):
        ...
        self._w3 = Arkiv(
            web3.HTTPProvider(endpoint_uri=config.host)
        )
        ...
        while not self._stop_event.is_set():
            try:
                entity_count = self._w3.arkiv.get_entity_count()
                ...
                logging.error(f"EntityCountUpdater: Error updating entity count: {e}", exc_info=True)
